...
class _AppHomeState extends State<AppHome> {
  ...
  void initState() {
    ...
    homeBloc.eventStreamSink.add(ApiAction.Fetch);
    homeBloc.eventReservationsSink.add(ApiAction.Fetch);
  }
                  ...
                  SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<Reservation>>(
                          stream: homeBloc.reservationsStream,
                          builder: (context, snapshot) {
                            if (snapshot.hasError) {
                              return Center(
                                child: Text(
                  ...
                  Expanded(
                    child: Padding(
                        ...
                        child: StreamBuilder<List<BusinessSnippet>>(
                          stream: homeBloc.snippetsStream,
                          builder: (context, snapshot) {
                            if (snapshot.hasError) {
                              return Center(
                                child: Text(
